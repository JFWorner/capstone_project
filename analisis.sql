...
-- Fija el esquema para que el resultado no dependa de la configuracion del cliente (DBeaver, pgAdmin, psql).
...
-- Base comun: una fila por linea vendida. Se excluyen cancelados y no disponibles
-- porque no generaron ingreso y contarlos inflaria la facturacion.
...
-- HAVING descarta estados con pocos pedidos, donde un porcentaje es puro ruido.
